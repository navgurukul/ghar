...
module.exports = {
  mongodbConnection: {
    fccCredential:process.env.mongodbUrl
  },
  auth:{
  ...
  ReadTheory: {
    read_theory_teacher: process.env.READ_THEORY_OWNER,
    read_theory_psw: process.env.READ_THEORY_PASSWORD,
  },
  googleSheet: {
  ...
  ZuvyAPIsJWT: {
    token: process.env.ZUVY_API_JWT,
  },
  zohoReports:{
