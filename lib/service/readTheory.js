...
class ReadTheoryService {
  ...
  async login() {
    try {
      ...
      // Check if login was successful and authentication cookie is received
  ...
  async getStudentsData(studentIds, token, cookie) {
    try {
      ...
      // Process the responses and extract student data
  ...
  async fetchStudentData(studentIds, delay) {
    ...
    // Create promises for fetching student data with delay
