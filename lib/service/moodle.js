          ...
          try {
            ...
            for (let topic of response) {
              ...
              if (topic.modules.length > 0) {
                ...
                if(minumDate) {
                    let month = minumDate.toLocaleString('default', { month: 'short' }).slice(0, 3);
                    leastDateAmongActivity = minumDate.getDate() + '-' + month + '-' + minumDate.getFullYear();
                }
                ...
                for (let activity of topic.modules) {
                  ...
                  topic.minDate =
                  ((leastDateAmongActivity != undefined )&& (leastDateAmongActivity!='NaN-Inv-NaN'))? leastDateAmongActivity: null;
                }
              } else {
