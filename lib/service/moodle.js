    ...
    try {
      ...
      for (const email in userData) {
          if (userData.hasOwnProperty(email)) {
              ...
              const user = userData[email].finalResponse.response.length >0 ? userData[email].finalResponse.response[0] : null;
              const topicName = user !==null ? user.name:null;
              const totalActivity =user !==null ?  user.totalActivity:null;
              const completedActivity = user !==null ? user.completedActivity:null;
              const complitionFlag =user !==null ?  user.complitionFlag:null;
              const latestActivity =user !==null ?  user.latestTime:null;
              const avgPercentage =user !==null ?  user.avgPercentage:null;
