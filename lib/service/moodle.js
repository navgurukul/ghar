  ...
  async filteringSubmativeAssessment(topicResponse) {
    try {
      ...
      if (topicResponse.length > 0) {
        if (
          topicResponse[0].completedActivity ==
            topicResponse[0].totalActivity &&
          topicResponse[0].totalActivity > 0
        ) {
        ...
        topicResponse[0].minDate =
          formattedDate == "1-Jan-1970" ? null : formattedDate;
