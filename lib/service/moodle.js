              ...
              if (topic.modules.length > 0) {
                for (let activity of topic.modules) {
                  if (activity.grade.status == "true") {
                    completedActivity++;
                    if (
                      new Date(activity.grade.timecompleted) >
                      new Date(latestTime)
                    ) {
                  ...
                  const minDateResult = minDateArray.toLocaleDateString(
                    "en-US",
                    options
                  );
                  ...
                  topic.minDate =
                    reorderedDate.length > 20 ? null : reorderedDate;
                }
              }else{
