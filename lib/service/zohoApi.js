      ...
      for (const platform of learningPlatformData.data) {
        if (platform.Name === learningProviderName) {
          ...
          for (const element of excelSheetData) {
            ...
            const foundData = getSystemId.data.filter((ele) => {
              console.log(ele.Navgurukul_Email, "ele.Navgurukul_Email");
              console.log(element[0], "element[0]");
              return ele.Navgurukul_Email == "renuka@navgurukul.org"
            });
            console.log(foundData, "foundData...321");
            if (foundData) {
              const updateData = {
                data: [
                  {
